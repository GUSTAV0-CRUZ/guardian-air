import Form from './validaformModule.min.js';import{SaibaMais}from "./saibamaisModule.min.js";const displayMostraValor=document.querySelector('#valorDoacaoEscolha');export function eventos(){addEventListener('click',e=>{const el=e.target;if(el.innerText==='R$5')return valorNoDiplay(el.innerText)
